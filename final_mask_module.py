...
def function():
    ...
    weightsPath= r"/home/pankaj/Desktop/merge_project/face_detector/res10_300x300_ssd_iter_140000.caffemodel"
...
# loop over the frames from the video stream
    while True:
        ...
        for (box, pred) in zip(locs, preds):
            ...
            # if(withoutMask>0.9):
            # 	challan(#something need to write parameter and make )
